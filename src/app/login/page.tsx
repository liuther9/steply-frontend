		...
		<div className={s.wrapper}>
			{!showCarousel && (
				<div className={s.login_container}>
					...
					<Form.Root className={s.form} onClearServerErrors={() => setServerErrors(false)} onSubmit={handleSignIn}>
						<Form.Field className={s.container} name='email' serverInvalid={serverErrors}>
							<div className={s.label_container}>
								...
								{serverErrors && <Form.Message className={s.error}>Неверный логин/пароль</Form.Message>}
							</div>
			...
			{showCarousel && <LoginCarousel closeCarousel={() => setShowCarousel(false)} />}
		</div>
	)
}
